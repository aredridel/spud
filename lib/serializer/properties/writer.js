...
ReadStream.prototype._process = function (namespace, data, newLine ) {
    ...
    /* Try to clone data so that the tree can be stripped down after updating meta: */
    try {
