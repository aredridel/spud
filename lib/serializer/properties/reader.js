...
function genParseError( lineIndex ) {
...
PropertyReader.prototype._doDeserialize = function(data, callback) {
    ...
    var parsedData = {}; // For tracking key/value pairs
    ...
    for ( var ln = 0; ln < lines.length; ++ ln ) {
        ...
        if ( keyValue ) {
            ...
            KeyHelper.setValue( parsedData, key, value );
